<script lang="ts">
	import { Button, Subheading, Avatar, cn } from '@foxui/core';
	...
	let {
		...
		loginOnSelect?: boolean;
		class?: string;
	} & Omit<HTMLFormAttributes, 'onsubmit' | 'action' | 'method'> = $props();
...
>
	...
	{#if signup}
		<div
			class="border-base-200 dark:border-base-800 text-base-800 dark:text-base-200 mt-2 flex flex-col gap-3 border-t pt-2 text-sm leading-7"
		>
