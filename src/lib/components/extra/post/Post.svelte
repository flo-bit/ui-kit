	...
	<div class="flex gap-4">
		...
		<div class="w-full">
			<div class="mb-1 flex items-start justify-between gap-2">
				<a
					class="group hover:bg-accent-900/5 -mx-2 -my-0.5 flex flex-col items-baseline gap-x-2 gap-y-0.5 rounded-xl px-2 py-0.5 sm:flex-row"
			...
			<div class="text-base-500 dark:text-base-400 mt-4 flex justify-between gap-2">
				...
				<button class="group inline-flex items-center gap-2 text-sm" onclick={() => {}}>
					{#if liked}
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
				...
				<button onclick={async () => {}} class="group inline-flex items-center gap-2 text-sm">
